...
class pedidos_imoveis extends controller {
	
	protected $_modulo_nome = "Pedidos";
	
	public function init(){
		$this->autenticacao();
		$this->nivel_acesso(135);
	}
	...
	public function inicial(){
		...
		// instancia
		$pedidos = new model_pedidos_imoveis();
		...
		$this->view('pedidos_imoveis', $dados);
	}
	...
	public function detalhes(){
		...
		$this->view('pedidos_imoveis.detalhes', $dados);
	}
	...
	public function ativar(){
		...
		$db = new mysql();
		$exec = $db->executar("SELECT * FROM imoveis_pedidos where codigo='$codigo' AND status<'2' ");				
		if($exec->num_rows == 1){
