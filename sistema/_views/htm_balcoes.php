							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left; padding-top:15px;">
										<select class="form-control select2" name="uf" onChange="window.location='<?=$_base['objeto']?>inicial/uf/'+this.value;"; >
											<option value="" selected="" >Filtro por estado</option>
											<?php
											foreach ($estados as $key => $value){
												
												if($estado_selecionado == $value['uf']){
													$selected = " selected ";
												} else {
													$selected = "";
												}
									...
									<table class="table table-bordered table-striped" id="tabela1">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td $linklinha >".$value['cidade']." - ".$value['uf']."</td>
												</tr>
												";
