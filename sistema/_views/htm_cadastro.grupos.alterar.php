...
<form action="<?=$_base['objeto']?>grupos_alterar_grv" class="form-horizontal" method="post" >
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-12">
				<select name="mostrar_titulo" class="form-control select2" >
		...
		<div class="form-group">
			...
			<div class="col-md-12">
				<select name="botao" class="form-control select2" > 
					<?php
		...
		<div class="form-group">
			<label class="col-md-12" >Habilitar dados para acesso</label>
			<div class="col-md-12">
				<select name="dados_acesso" class="form-control select2" >
					<option value='1' <?php if($data->dados_acesso == 1){ echo " selected='' "; } ?> >Sim</option>
					<option value='0' <?php if($data->dados_acesso == 0){ echo " selected='' "; } ?> >Não</option> 
				</select>
			</div>
		</div>
