...
function get_plans()
{
  ...
  while ($i != 0) {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://app.vindi.com.br/api/v1/plans?page=' . $i . '&per_page=200&sort_by=created_at&sort_order=desc',
    ...
    curl_close($curl);
    array_push($all_planos['plans'], $response['plans']);
...
<head>
  ...
  <style>
    .conteudo_lista {
      padding: 10px;
      border-bottom: 1px #222d32 solid;
      ;
      margin: 10px 0px;
    }
          ...
          <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <select class="form-control select2" id="planos_list" name="assinatura" data_id="<?= $data->plano_id ?>">
                                ...
                                ?>
                                    <option data-preco="<?= ($preco_v > 0 ? $preco_v : 0) ?>" data-intervalo="<?= ($intervalo != '' ? $intervalo : '') ?>" value='<?= $plan['id'] ?>' <?php if ($data->plano_id == $plan['id']) {
                                                                                                                                                                                        echo "selected";
                                                                                                                                                                                      } ?>><?= $plan['id'] . ' - ' . $plan['name'] ?></option>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input name="intervalo" id="intervalo" type="text" class="form-control" disabled value="<?= $intervalo_ ?>">
                              <input name="intervalo_" id="intervalo_" style="display:none" type="text" class="form-control" value="<?= $intervalo_ ?>">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <select class="form-control select2" name="usar_desconto">
                                <option value='0' <?php if ($data->usar_desconto == 0) {
                                                    echo "selected";
                                                  } ?>>Näo</option>
                                <option value='1' <?php if ($data->usar_desconto == 1) {
                                                    echo "selected";
                                                  } ?>>Sim</option>
                              </select>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <select class="form-control select2" name="privado">
                                <option value='1' <?php if ($data->privado == 1) {
                                                    echo "selected";
                                                  } ?>>Sim</option>
                                <option value='0' <?php if ($data->privado == 0) {
                                                    echo "selected";
                                                  } ?>>Näo</option>
                              </select>
                            </div>
                ...
                <div id="imagem" class="tab-pane <?php if ($aba_selecionada == "imagem") {
                                                    echo "active";
                                                  } ?>">
                ...
                <div id="categorias" class="tab-pane <?php if ($aba_selecionada == "categorias") {
                                                        echo "active";
                                                      } ?>">
                ...
                <div id="conteudo_curso" class="tab-pane <?php if ($aba_selecionada == "conteudo_curso") {
                                                            echo "active";
                                                          } ?>">
                ...
                <div id="feedback" class="tab-pane <?php if ($aba_selecionada == "feedback") {
                                                      echo "active";
                                                    } ?>">
    ...
    $(document).ready(function() {
      ...
      $("#sortable_imagem").sortable({
        update: function(event, ui) {
          ...
          $.post('<?= $_base['objeto'] ?>ordenar_imagem', {
            list: postData,
            codigo: '<?= $data->codigo ?>'
          }, function(o) {
            console.log(o);
