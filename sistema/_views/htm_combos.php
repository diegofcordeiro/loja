							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>novo', 'Novo Combo');">Novo Combo</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td><a href='".$_base['objeto']."alterar_combo/codigo/".$value['id']."' >".$value['titulo']."</a></td>
												</tr>
												";
