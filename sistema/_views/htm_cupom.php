							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="window.location='<?=$_base['objeto']?>novo';">Nova Promoção</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td $linklinha >R$ ".$value['desconto_fixo']."</td>
												<td $linklinha >".$value['desconto_porc']." %</td>
												</tr>
												";
