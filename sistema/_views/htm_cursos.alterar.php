            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content" >
                <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
                  <form action="<?=$_base['objeto']?>alterar_curso_dados" class="form-horizontal" method="post">  						
                    <fieldset>
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="titulo" type="text" class="form-control" value="<?=$data->nome?>" >
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-2">
                                <div class="form-group">
                                <label class="col-md-12">Duração</label>
                                <div class="col-md-12">
                                    <input name="duracao" type="text" class="form-control" value="<?=$data->duracao?>">
                                </div>
                                </div>
                            </div>  -->
                            <!-- <div class="col-md-2">
                                <div class="form-group">
                                    <label class="col-md-12">Estrelas</label>
                                    <div class="col-md-12">
                                        <select class="form-control select2" name="avaliacao" >
                                        <option value='0' <?php if($data->avaliacao == 0){ echo "selected"; } ?> >0</option>
                                        <option value='1' <?php if($data->avaliacao == 1){ echo "selected"; } ?> >1</option>
                                        <option value='2' <?php if($data->avaliacao == 2){ echo "selected"; } ?> >2</option>
                                        <option value='3' <?php if($data->avaliacao == 3){ echo "selected"; } ?> >3</option>
                                        <option value='4' <?php if($data->avaliacao == 4){ echo "selected"; } ?> >4</option>
                                        <option value='5' <?php if($data->avaliacao == 5){ echo "selected"; } ?> >5</option>
                                        </select>
                                    </div>
                                </div>
                            </div>  -->
                        ...
                        <div class="form-group" style="display:none">
                            ...
                            <div class="col-md-12">
                            <textarea name="previa" rows="5" class="form-control" ><?=$data->nome?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-12">Descrição Card</label>
                            <div class="col-md-12">
                            <textarea class="form-control" name="descricao_card" ><?=$data->descricao_card?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div id="show_conteudo2">
                            <div class="row" style="margin-top:10px">
                              <div class="col-md-3 mb-12">
                                    <select name="icon[]" id="icon" class="form-control">
                                      <option value="0">Curso SCORM</option>
                                      <option value="1" <?php if($row['icon']==1) echo 'selected'?>>Video Youtube</option>
                                      <option value="2" <?php if($row['icon']==2) echo 'selected'?>>Videoaula</option>
                                      <option value="3" <?php if($row['icon']==3) echo 'selected'?>>Podcast</option>
                                      <option value="4" <?php if($row['icon']==4) echo 'selected'?>>PDF</option>
                                      <option value="5" <?php if($row['icon']==5) echo 'selected'?>>Avaliação</option>
                                    </select>
                                </div>
                                <div class="col-md-2 mb-12">
                                ...
                                <div class="col-md-3 mb-12">
                                    <input type="text" name="visualizaca[]" class="form-control" placeholder="Insira o Link" value="<?=$row['visualizar']?>">
                                </div>
                                <!-- <div class="col-md-2 mb-12">
