        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-body">
              ...
              <div>
               <button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>novo_canal', 'Novo Canal');">Novo Canal</button>
               <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>';" >Voltar</button>
             </div>

             <hr>

             <!-- <div style="padding-bottom:20px;" >Voc&ecirc; pode arrastar para cima e para baixo para ordenar e para os lados para sub-canal.</div> -->

             <div class="dd" id="nestable">                    
              <?php

              function montacanaisView($id_pai, $canais){
                ...
                foreach ($canais as $key => $value) {
                  ...
                  if($value['id_pai'] == $id_pai){
                   ...
                   <div class="dd3-content-editar" onClick="modal(\''.DOMINIO.'produtos/alterar_canal/codigo/'.$value['id'].'\', \'Alterar canal\');" ><i class="far fa-edit"></i></div>
                   <div class="dd3-content-apagar" onClick="confirma(\''.DOMINIO.'produtos/apagar_canal/codigo/'.$value['id'].'\');" ><i class="fas fa-trash"></i></div>
                   <div class="dd3-content">'.$value['nome'].'</div>';
           ...
           <div>
            <form action="<?=$_base['objeto']?>salva_ordem_canais" method="post" >
