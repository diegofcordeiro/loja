		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					...
					<div class="col-xs-12">    		
						<form action="<?=$_base['objeto']?>salvar_estoque" method="post" >
							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>alterar_estoque', 'Alterar Estoque');">Alterar Estoque</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												$linklinha = "onClick=\"modal('".$_base['objeto']."alterar_estoque/produto/".$value['produto']."/tamanho/".$value['tamanho']."/cor/".$value['cor']."/variacao/".$value['variacao']."/', 'Alterar Estoque');\"style='cursor:pointer;' ";
												
												$extrato = "onClick=\"modal('".$_base['objeto']."extrato_estoque/registro/".$value['registro']."/', 'Extrato');\"style='cursor:pointer;' ";
												
												echo "
												<tr>
												<td $linklinha >".$value['produto_ref']."</td>
