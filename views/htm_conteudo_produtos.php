		...
		?>
						...
						<div class="item">
							<div class="grid1">
								...
								<div class="bottom_card" style="">
									<div>
										<a href="<?= $saiba_mais ?>" onclick="acessando(this);">
			...
			if (isset($combos) and (count($combos) > 0 and $forma_pagamento == 5)) {
				...
				foreach ($combos as $key => $value) {
					...
					if ($value['privado'] == 0) {
						...
						$valor_principal_ = 0;
						$qtd_cursos_ = null;
						$media_estrelas_ = null;
						$hours_ = null;
						$minutes_ = null;
						$seconds_ = null;
						$data_atualizacao_ = null;
						$tags_cat_ = array();
						...
						if ($minutes_ > 0) {
							$minutes_ = $minutes_ . 'min ';
						} else {
							$minutes_ = '';
						};
						if ($seconds_ > 0) {
							$seconds_ = $seconds_ . 'seg ';
						} else {
							$seconds_ = '';
						};
