			...
			<div class="row">
                <div class='col-xs-12 col-sm-7 col-md-7'>
                    ...
                    <div class="desc_bloc">
                        ...
                        <span style="color: #939393;font-size: 15px;"><?php if($qtd_conteudo==1){echo $qtd_conteudo.' seção';}else{echo $qtd_conteudo.' seções';}?> • <?php if($total_aulas==1){echo $total_aulas.' aula';}else{echo $total_aulas.' aulas';}?> Duração total: <?=$total_minutos?></span>
                            ...
                            <div class="panel-group" id="accordion" data-toggle="collapse" data-target="#collapse<?=$value['id']?>" style="margin-bottom: 5px;cursor: pointer;">
                                <div class="panel panel-default">
                                    ...
                                    <h4 class="panel-title">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$value['id']?>" style="float:right;padding-right: 10px;"> <?=$total_aulas?> <?php if($total_aulas == 1){echo ' Aula';}else{echo ' Aulas';} ?> - <?=$total_minutos?></a>
                                    </h4>
                                    </div>
                            ...
                            <div class="qtd_estrelas">
                                ...
                                <div class="overall__estrelas">
                                    <div style="margin-top: 15px;">
                                        <?php if(floor($total_estrelas) == 0){ echo "<i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if(floor($total_estrelas) == 1){ echo "<i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if(floor($total_estrelas) == 2){ echo "<i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if(floor($total_estrelas) == 3){ echo "<i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_cinza'></i> <i class='f25 fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if(floor($total_estrelas) == 4){ echo "<i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if(floor($total_estrelas) == 5){ echo "<i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i> <i class='f25 fas fa-star estrela_amarela'></i>";} ?>
                                    </div>
                                ...
                                <?php foreach($estrelas as $key => $row){
                                    ...
                                    <div class="row" style="margin:0;margin-top: -20px;">
                                        ...
                                        <div class="estrela_lista">
                                            <?php if(floor($key) == 0){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i>";} ?>
                                            <?php if(floor($key) == 1){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                            <?php if(floor($key) == 2){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                            <?php if(floor($key) == 3){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                            <?php if(floor($key) == 4){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        </div>
                            ...
                            <div style="margin-top: 100px;">
                                ...
                                <div>
                                    ...
                                    <div class="estrela_feedback">
                                        <?php if($row['estrela'] == 0){ echo "<i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if($row['estrela'] == 1){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if($row['estrela'] == 2){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if($row['estrela'] == 3){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if($row['estrela'] == 4){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_cinza'></i>";} ?>
                                        <?php if($row['estrela'] == 5){ echo "<i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i> <i class='fas fa-star estrela_amarela'></i>";} ?>
                                    </div>
                                </div>
