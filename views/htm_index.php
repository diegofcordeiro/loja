        ...
        ?>
          <script type="text/javascript">
            function enviar_rastr_<?= $conteudo_id ?>() {
              ...
              $.post('<?= DOMINIO ?><?= $controller ?>/rastreamento_detalhes', {
                rastreio_codigo: rastreio_codigo
              }, function(data) {
                if (data) {
        ...
        ?>
          ...
          <script>
            function duvidas_respostas_<?= $conteudo_id ?>(codigo) {
              ...
              $.post('<?= DOMINIO ?><?= $controller ?>/duvidas_respostas', {
                codigo: codigo
              }, function(data) {
                if (data) {
        ...
        ?>
            ...
            <script>
              function videos_categoria_<?= $conteudo_id ?>(categoria) {
                ...
                $.post('<?= DOMINIO ?><?= $controller ?>/videos_categoria', {
                  categoria: categoria,
                  itens_por_linha: '<?= $videos_config->itens_por_linha ?>',
                  mostrar_titulo_video: '<?= $videos_config->mostrar_titulo_video ?>'
                }, function(data) {
                  if (data) {
        ...
        ?>
            ...
            <script>
              function audios_categoria_<?= $conteudo_id ?>(categoria) {
                ...
                $.post('<?= DOMINIO ?><?= $controller ?>/audios_categoria', {
                  categoria: categoria,
                  itens_por_linha: '<?= $audios_config->itens_por_linha ?>',
                  mostrar_titulo_video: '<?= $audios_config->mostrar_titulo_video ?>'
                }, function(data) {
                  if (data) {
        ...
        ?>
            ...
            <script>
              function fotos_categoria_<?= $conteudo_id ?>(categoria) {
                ...
                $.post('<?= DOMINIO ?><?= $controller ?>/fotos_categoria', {
                  categoria: categoria,
                  itens_por_linha: '<?= $fotos_config->itens_por_linha ?>',
                  formato: '<?= $fotos_config->formato ?>',
                  max_itens: '<?= $fotos_config->max_itens ?>'
                }, function(data) {
                  if (data) {
              ...
              $(function() {
                ...
                $("#slider-range_alugar_<?= $conteudo_id ?>").slider({
                  ...
                  slide: function(event, ui) {
                    ...
                    var min_tratado = ui.values[0].toLocaleString('pt-br', {
                      style: 'currency',
                      currency: 'BRL'
                    });
                    var max_tratado = ui.values[1].toLocaleString('pt-br', {
                      style: 'currency',
                      currency: 'BRL'
                    });
                ...
                var min_tratado = $("#slider-range_alugar_<?= $conteudo_id ?>").slider("values", 0).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                var max_tratado = $("#slider-range_alugar_<?= $conteudo_id ?>").slider("values", 1).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                $("#imov_amount_alugar_<?= $conteudo_id ?>").val(min_tratado + " - " + max_tratado);
                ...
                var min_tratado = $("#slider-range_comprar_<?= $conteudo_id ?>").slider("values", 0).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                var max_tratado = $("#slider-range_comprar_<?= $conteudo_id ?>").slider("values", 1).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                $("#imov_amount_comprar_<?= $conteudo_id ?>").val(min_tratado + " - " + max_tratado);
        ...
        ?>
            ...
            <script>
              ...
              function carrega_bairros_<?= $conteudo_id ?>(cidade) {
                ...
                $.post(endereco_arquivo, {
                  cidade: cidade,
                  bairro: '<?= $classificados_bairro_selecionado ?>'
                }, function(data) {
                  if (data) {
                    $('#bairros_lista_<?= $conteudo_id ?>').html(data);
                  }
            ...
            <script>
              $(function() {
                ...
                var min_tratado = $("#slider-range_<?= $conteudo_id ?>").slider("values", 0).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                var max_tratado = $("#slider-range_<?= $conteudo_id ?>").slider("values", 1).toLocaleString('pt-br', {
                  style: 'currency',
                  currency: 'BRL'
                });
                $("#cla_amount_<?= $conteudo_id ?>").val(min_tratado + " - " + max_tratado);
