...
<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="titulo_padrao" >Envie seu imóvel</h2>
				...
				<div class='col-xs-12 col-sm-6 col-md-6'>
					<form id="cadastro_imovel" name="cadastro_imovel" >
						<div class="cadastro_div" >
							...
							<div class="div_form" >
								<label>Titulo para o Imóvel</label>
								<input type="text" class="form-control cadastro_form" name='titulo' placeholder="Ex: Apartamento no Centro" >
							</div>
	...
	<script> 
		...
		function salvar(){
			...
			$.post('<?=DOMINIO?><?=$controller?>/adicionar_imovel_grv', dados,function(data){            
				if(data){ 
