					...
					<?php if( ($forma_pagamento->id == 3) AND ($data_pedido->status <= 3) ){ ?>
						...
						<div style="margin-top:20px;" >
							...
							<form id="form-checkout" action="<?=DOMINIO?>index/mercadopago_flow" method="POST">
								...
								<div class="row">
									...
									<div class="col-xs-4 col-md-4">
										<div class="form-group">	
											...
											<input type="hidden" class="form-control" name="cpf" value="<?=$cpf?>"  />
										</div>
									</div>
								</div>
								<hr>
								...
								<div class="row">
									<div class="col-xs-12">
										<button type="submit" class="btn btn-success btn-lg btn-block"  id="form-checkout__submit">Pagar</button>
									</div>
								</div>
