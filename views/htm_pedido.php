...
<body>
				...
				<div class="col-sm-12">
					...
					<?php if (($forma_pagamento->id == 1) and ($data_pedido->status <= 3)) { ?>
						<div style="margin-top:20px;">
							...
							<br><br>
							<!-- <form id="comprar_pagseguro" action="<?= URL_PAGSEGURO ?>checkout/v2/payment.html" method="post" onsubmit="PagSeguroLightbox(this); return false;">
						...
						<form name="formulario_" id="formulario_" method="POST" action="<?= DOMINIO ?>index/vindi_flow">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="div_form">
										<label>País</label><br>
										<input type="radio" id="Brasil_end" name="country_endereco" <?= ($data_dados->is_brasil_address == 1 or $data_dados->is_brasil_address == null) == 1 ? 'checked' : '' ?> value="1">
										<label for="Brasil">Brasil </label>
										<input type="radio" id="Outros_end" name="country_endereco" <?= ($data_dados->is_brasil_address == 0 and $data_dados->is_brasil_address != null) ? 'checked' : '' ?> value="0">
										<label for="Outros">Outros</label><br>
									</div>
								</div>
							</div>
							<br>
							<div class="endereco_brasil" style="<?= ($data_dados->is_brasil_address == 1 or $data_dados->is_brasil_address == null) ? '' : 'display: none' ?>">
								<div class="row">
									<div class="col-xs-10">
										<div class="form-group">
											<label for="cardNumber">Endereço</label>
								...
								<div class="row">
									...
									<div class="col-xs-3 col-md-3">
										<div class="form-group">
											<label for="cidade">Estado</label>
											<select id="estado" class="form-control" name="estado" onChange="cadastro_cidades(this.value)">
												<?php
							...
							<div class="endereco_outros" style="<?= ($data_dados->is_brasil_address == 0 and $data_dados->is_brasil_address != null) ? '' : 'display: none' ?>">
								<div class="row">
									<div class="col-xs-10">
										<div class="form-group">
											<label for="cardNumber">Endereço</label>
	...
	<script>
		...
		<?php if ($data_dados->estado && $data_dados->is_brasil_address == 0) { ?>
