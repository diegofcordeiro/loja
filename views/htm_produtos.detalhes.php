...
<head>
	...
	<style type="text/css">
		...
		.pontuacao_curso>span:nth-child(1) {
			text-align: left;
		}

		.pontuacao_curso>span:nth-child(2) {
			text-align: right;
		}
								...
								<?php if ($data->only_combo != 1) { ?>
									<div class='col-xs-12 col-sm-3 col-md-3' id="<?= $data->only_combo ?>">
										<div class="produto_detalhes_valor" style="text-align: center;">
											...
											<div class="produtos_detalhes_valortotal" style="margin-top: 0px; font-weight:500;color:white">Investimento:</div>
											<?php if ($valor_de != '0,00') { ?>
												<div style="color: #9C9C9C;font-size: 24px;font-weight: 300;text-decoration: line-through;">R$ <?= $valor_de ?></div>
											<?php } ?>
											<span id="produto_valor_unitario" style="color:white">
												<span style="color:white;font-size: 30px;">R$</span>
												<span style="color:white;margin-left: -5px;font-size: 50px;"><?= $valor_principal[0] ?></span>
												<span style="color:white;font-size: 30px;margin-left: -10px;">,<?= $valor_principal[1] ?>
												</span>
															...
															<div class="grid1">
																...
																<div class="desc_text" style="margin-left: 8px;">
																	<div class="name-author all">
																		<a style="color: white;" href="<?= $endereco ?>"><?= $value['nome'] ?></a>
																	</div>
																	<p class="nome_trilha_curso"><?= $data->titulo ?></p>
																	<div class="pontuacao">
																		<ul>
																			<li><i class="fas fa-graduation-cap"></i> <?= count($curso_conteudo) ?> <?php if (count($curso_conteudo) <= 1) {
																																						echo 'aula';
																																					} else {
																																						echo 'aulas';
																																					} ?></li>
																...
																<div style="padding-left: 8px;">
																	<a href="<?= $endereco ?>">
																		<div><i style="float: left;border: 2px white solid;padding: 5px 8px;border-radius: 15px;color: white;font-size: 10px;margin-left: 8px;" class="fas fa-info"></i>
																			<p style="color: white;font-weight: 500;margin-left: 6px;float: left;" class="">SAIBA MAIS</p>
																		</div>
																	</a>
																	<div></div>
																</div>
